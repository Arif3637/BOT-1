...
const nam = [{
    ...
    message: ['~ এখন রাত ১২টা বেজে গেলো সবাই শুয়ে পড়ো🤟']
						...
						{
    timer: '2:00:00 AM',
    message: ['~এখন রাত ১টা বাজে প্রেম না কইরা যাইয়া ঘুমাও😾']
},
						 {
    timer: '3:00:00 AM',
    message: ['~এখন রাত ২টা বাজে 🫠🫠।']
						 ...
						 {
    timer: '4:00:00 AM',
    message: ['~এখন রাত ৩টা বাজে সবাই সেহরি খাওয়ার জন্য উঠে পড়ো  ']
},
						 {
    timer: '5:00:00 AM',
    ...
    message: ['~ এখন বিকাল ৪টা বাজে আসরের আযান দিলে সবাই নামাজ পড়ে নাও🥀 ']
						 ...
						 {
    timer: '6:00:00 PM',
    message: ['~এখন বিকাল ৫টা বাজে সবাই আসরের নামাজ পড়ে নাও 😻']
},
						 {
    timer: '7:00:00 PM',
    message: ['~এখন সন্ধ্যা ৬টা বাজে সবাই ইফতারের জন্য রেডি হয়ে নাও😍. ']
},
             {
    timer: '8:00:00 PM',
    message: ['এখন সন্ধ্যা ৭ টা বাজে কি করছো সবাই এখন এশার আযান দিবে সবাই নামাজ পড়তে যাও❤️']
},
             {
    timer: '9:00:00 PM',
    message: ['~এখন রাত ৮টা বাজে সবাই নামাজে যাও']
},
             {
    timer: '10:00:00 PM',
    message: ['এখন রাত ৯টা বাজে 🙂']
            ...
            {
    timer: '11:00:00 PM',
    message: ['~এখন রাত ১০টা বাজে সবাই ঘুমায় পড়ো আমার বউ নাই ভাই ঘুম ও আসে না আমি একটা বট সবাই ঘুমিয়ে পড়ো😭']
}];
