module.exports.config = {
  ...
  version: "1.0.0",
  credits: "Mirai-Team", // FIXED BY YAN ARIF 
...
.then(response => {
    ...
    return api.sendMessage("চলে এসেছি আমি পিচ্চি ARIF তোমাদের মাঝে🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
https://www.facebook.com/Arif.gm2bd

🔵WHATSAPP NUMBER: wa.me/+8801868342143

🟢SUPPORT EMAIL: www.mda433515@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
})
.catch(error => {
    console.error(error);
});
